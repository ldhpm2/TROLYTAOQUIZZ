        ...
        <div className="max-w-4xl mx-auto px-6 py-8">
            ...
            <div className="bg-gradient-to-br from-teal-500 to-cyan-600 rounded-2xl p-8 text-white mb-6 shadow-xl">
                <div className="flex items-start gap-6">
                    ...
                    <div className="flex-1">
                        ...
                        <h3 className="text-3xl font-black mb-4">Cô Hồ Thị Thùy Linh</h3>
                        ...
                        <div className="space-y-3">
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <div className="font-bold text-lg">0972968098</div>
                                </div>
            ...
            <div className="mt-8 text-center">
                <p className="text-sm text-slate-500">
                    Có vấn đề khác? Liên hệ qua Zalo: <strong className="text-primary">0972968098</strong>
                </p>
            </div>
        </div>
    );
